// This file contains a local implementation of the LambdaResourceDetector
// from the opentelemetry-aws crate. It's a temporary solution while waiting
// for the opentelemetry-aws crate to be updated to version 0.13.0.
// Once the update is available, this file will be removed and the
// official crate dependency will be used instead.
